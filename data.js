...
var q = {
  1: {
    ...
    "type": "EI",
    "A": "새로운 사람을 만난다는 생각에 기분이 좋아진다.",
    "B": "모르는 사람이니까 일단 눈치를 본다."
  },
  2: {
    "question": "학교에서 시험을 볼 때",
    "type": "JP",
    "A": "미리 계획을 짜서 어떤 과목을 공부 할지 정해 놓는다.",
  ...
  3: {
    ...
    "type": "EI",
    "A": "친구들이랑 같이하는 것이 편하다.",
    "B": "혼자 또는 다른 친구 한명 정도와 일하는 것이 편하다."
  },
  4: {
  ...
  8: {
    ...
    "B": "되게 재미있고... 내가 이 게임을 했을 때 느낀 감정을 소개한다."
  },
  9: {
    "question": "내가 생각하는 학교 교칙은?",
    "type": "JP",
    "A": "학교 생활을 어느 정도 통제하기 위해 필요하다고 생각한다.",
    "B": "나는 자유로움을 추구해 딱히 필요없거나 통제를 줄여야 한다고 생각한다."
  },
  10: {
    "question": "학교 국어 시간에 글쓰기 수행 평가가 있을 때",
    "type": "SN",
    "A": "주제가 정해져야 글쓸 때 마음이 편하다.",
    "B": "주제없이 그냥 내가 표현하고 싶은 걸 쓰고 싶다."
  },
  11: {
